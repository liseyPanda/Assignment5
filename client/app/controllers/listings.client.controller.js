angular.module('listings').controller('ListingsController', ['$scope', '$location', '$stateParams', '$state', 'Listings', 
  function ($scope, $location, $stateParams, $state, Listings) {
      ...
      $scope.create = function (isValid) {
          ...
          Listings.create(listing)
                  .then(function (response) {
                      ...
                      $state.go('listings.list', { successMessage: 'Created successfully' });
                  }, function (error) {
      ...
      $scope.update = function (isValid) {
          ...
          Listings.update($scope.listing._id, listing)
            .then(function (response) {
                ...
                $state.go('listings.list', { successMessage: 'List is Updated' });
            }, function (error) {
      ...
      .then(function (response) {
          $state.go('listings.list', { successMessage: 'Deleted entry' });
